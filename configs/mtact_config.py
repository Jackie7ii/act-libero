MTACT_LIBERO_CONFIG = {
    ...
    # Path to the sentence-transformer task embedding dict generated by utils/gen_task_emb.py
    'task_emb_path':    '/local_data/jl17265/projects/act-libero/task_embeddings/libero_spatial_task_embeddings.npy',
    ...
    'qpos_dim':           8,
    'dropout':           0.1,
    'multi_task':         True,   # enable task-embedding conditioning
    'task_emb_dim':       384,    # dimension of the sentence-transformer task embedding
    ...
    # save
    'ckpt_dir':   '/local_data/jl17265/projects/act-libero/ckpt/mtact_libero_spatial0',
    'video_dir':  '/local_data/jl17265/projects/act-libero/ckpt/mtact_libero_spatial0',
    'save_every': 100,
